Class WarCampaignMap {
    __New(Firestone) {
        ...
        this.missions := Map(
            ...
            'titans', MapMissions(this.Firestone, [MapMission(1167, 4, true), MapMission(1099, 15, true), MapMission(1209, 2, true), MapMission(1278, 2, true)], Button(this.Firestone, 0xE7DBB5, 3)),
        )
    }
